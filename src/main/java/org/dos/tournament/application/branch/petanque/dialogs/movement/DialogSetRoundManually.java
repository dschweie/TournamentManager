...
public class DialogSetRoundManually extends JDialog {
  ...
  private ArrayList<ArrayList<ArrayList<Slot>>> grid;
  ...
  public DialogSetRoundManually() {
    ...
    this.setTitle(ResourceBundle.getBundle(TournamentManagerUI.MESSAGES).getString("Supermelee.Action.CreateRoundManually.name"));
    ...
    JButton btnFillUp = new JButton(ResourceBundle.getBundle(TournamentManagerUI.MESSAGES).getString("DialogSetRoundManually.btnNewButton.text")); //$NON-NLS-1$ //$NON-NLS-2$
  ...
  public DialogSetRoundManually(SuperMelee tournament, ArrayList<ArrayList<ArrayList<Slot>>> grid, ArrayList<IParticipant> participants)
  {
    this();
  ...
  private class SwingActionCreateMatchday extends AbstractAction {
    public SwingActionCreateMatchday() {
      putValue(NAME, ResourceBundle.getBundle(TournamentManagerUI.MESSAGES).getString("Common.OK.name"));
  ...
  private class SwingActionFillUpForm extends AbstractAction {
    public SwingActionFillUpForm() {
      putValue(NAME, ResourceBundle.getBundle(TournamentManagerUI.MESSAGES).getString("DialogSetRoundManually.FillUp.name"));
      putValue(SHORT_DESCRIPTION, ResourceBundle.getBundle(TournamentManagerUI.MESSAGES).getString("DialogSetRoundManually.FillUp.shortDescription"));
    }
    public void actionPerformed(ActionEvent e) {
