...
public abstract class AbstractTournamentWizardPanel extends JPanel
{
  ...
  public static final String PETANQUE_SUPERMELEE        = "supermelee";
  public static final String PETANQUE_MONATSTURNIER     = "monatsturnier_gg";
  public static final String PETANQUE_DOUBLETTESWISS    = "doublette_formee_swiss";
